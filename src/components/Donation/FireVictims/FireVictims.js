...
const FireVictims = () => {
  ...
  const handleFormCOntrol = (e) => {
    ...
    const fundCategory = "emergencyFund";
    const fundType = "fireVictims";
    ...
    if (name && email && amount) {
      ...
      //   .then((res) => res.json())
      //   .then((data) => console.log(data));
      // top donor list value send ending here
    } else {
      console.log("error");
    }
  };
      ...
      <section>
        <div className="card m-3 w-75 mx-auto">
          ...
          <div className="card-body">
            <h5 className="card-title">Support for fire burned People </h5>
